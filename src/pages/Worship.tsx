...
export default function Worship() {
  ...
  return (
    <div className="mx-5 my-10 space-y-4">
      <h1 className="text-4xl font-medium text-center">Weekly Worship</h1>
      <br />
      ...
      <HomeSection
        text={
          <p>
            J.A.M. is our Wednesday evening programming and is held through the school year. Dinner
            is served at 6:00 and the program goes from 6:30-7:30.
          </p>
        }
        image={JamLogo}
      ...
      <HomeSection
        text={
          <p>
            ...
            <br /> <br />
            Worship services are Sundays at 10:45 AM. There is a fellowship time after the service.

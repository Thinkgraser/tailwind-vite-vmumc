...
export default function Jam() {
  ...
  return (
    <div className="mx-5 my-10 space-y-4">
      <h1 className="text-4xl font-medium text-center">J.A.M</h1>
      <br />
      ...
      <HomeSection
        text={
          <div className="space-y-4">
            ...
            <p>
              Our Wednesday program, J.A.M. (Jesus and Me), is designed for elementary-age children
              to learn the love of Jesus while having fun. It is held (almost) every Wednesday
              through the school year. Dinner is served at 6:00 and the program goes from 6:30-7:30.
            </p>

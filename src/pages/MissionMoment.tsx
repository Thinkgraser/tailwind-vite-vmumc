          ...
          text={
            <div className="space-y-4">
              <p>
                ...
                <br />
                This month's mission is in support of Families Forward, a merger of Bidwell
                Riverside Center and Hawthorn Hill. The original four programs -- Bidwell Pantry,
                Child Develop-ment Center, New Directions Shelter, and The Home Connection --
                remain, work-ing together to provide compassionate, life-changing assistance to
                families and their path to self-sufficiency.
              </p>
              <p>
                ...
                families put food on their tables and clothes on their backs, reducing the strain
                the families are experiencing, enabling them to focus on other ways they can help
                themselves.
              </p>
            </div>
          }

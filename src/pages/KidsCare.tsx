  ...
  return (
    <>
      <div className="text-center text-4xl font-medium pt-3 mt-10 mx-3">
        <h1>Welcome to Van Meter United Methodist Kids Care</h1>
      </div>
      <div className="mx-5 my-10 space-y-7">
          ...
          text={
            <div className="space-y-4">
              ...
              <p>
                ...
                <a
                  className="link"
                  href="/Publications/KidsCare2024Preschool(Fall)Registration.pdf">
        ...
        <div>
          <ul className="space-y-1 ms-4 list-disc">
            <li>
              Kids Care is a not-for-profit DHS licensed childcare center for elementary-age
              students.
            </li>
            <li>
            ...
            <li>
              Our activities will foster an awareness of Christ, such as actions and attitudes in
              our response to others and self. We will strive to create an atmosphere where the
        ...
        <div className="space-y-4 ms-8">
          ...
          <p>
            <strong>children ages 4-5 </strong>attending <strong>AM</strong> preschool session at
          ...
          <p>
            <strong>children ages 4-5 </strong>attending <strong>PM</strong> preschool session at
            Van Meter Elementary
            <br />
        ...
        <div>
          <ul className="space-y-1 ms-12 list-disc">
            ...
            <li>
              Un-scheduled early dismissal / late start days from school: Child care will be

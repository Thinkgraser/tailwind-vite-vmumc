...
export default function Vbs() {
  ...
  return (
    <div className="mx-5 my-10 space-y-4">
      <h1 className="text-4xl font-medium text-center">VBS: Vacation Bible School</h1>
      <br />
      ...
      <p>
        ...
        what they liked best about VBS the answers were as varied as the VBS learning stations. Some
        liked songs, some liked snacks, some liked the outdoor games, or crafts, or science, or
        story time. With all that, what's not to like? Come and enjoy the holychaos of Vacation

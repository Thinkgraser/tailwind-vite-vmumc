      ...
      <HomeSection
        text={
          <div className="space-y-4">
            ...
            <p>
              Scholarships are available from our church, from the Iowa United Methodist Foundation,
              and at the national level from GBHEM, the General Board of Higher Education and
              Ministry.
            </p>
            <p>

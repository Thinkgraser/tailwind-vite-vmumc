      ...
      <div className="lg:grid grid-cols-2">
        ...
        <div className="space-y-4">
          <p>
            ...
            faith, so rather than "giving up" you might want to commit to "adding to" or beginning a
          ...
          <p>
            ...
            meditation, or beginning a devotional time. Whether you choose to give up or add to, you
            can be humble and hopeful that your Lenten practice will deepen your faith.
          </p>
        </div>
      </div>
    </div>

...
export default function Education() {
  ...
  return (
    <div className="mx-5 my-10 space-y-12">
      <h1 className="text-4xl font-medium text-center">Bringing Us Closer to God</h1>
      <br />
        ...
        text={
          <div className="space-y-4">
            <p>
              ...
              Sunday in the overflow area at the back of the sanctuary. We usually take a break for
              the summer.
            </p>
            <p>
              ...
              (almost) every Wednesday through the school year, a dinner followed by an hour of fun
              learning.{" "}

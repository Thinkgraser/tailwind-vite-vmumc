  ...
  return (
    <div className="mx-5 my-10 space-y-7">
      ...
      <p>
        ...
        usual. The best gifts are those that make you feel warm inside, either giving or receiving.
      </p>
      <p className="mx-10">
        ALTERNATIVE CHRISTMAS says that having more "stuff" is not as important as making the world
        a better place. Are you looking for that special gift -- a gift that gives twice?
      </p>
      <p className="mx-10">
        An ALTERNATIVE CHRISTMAS mission project is an easy, convenient and thoughtful way to "buy"
        a gift for anyone.
      </p>
      ...
      <h4 className="text-center font-medium text-2xl">Alternative Christmas Giving Suggestions</h4>

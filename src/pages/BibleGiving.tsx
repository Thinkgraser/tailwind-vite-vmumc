...
export default function BibleGiving() {
  ...
  return (
    <div className="mx-5 my-10 space-y-4">
      <h1 className="text-4xl font-medium text-center">Bible Giving</h1>
      <br />
      <hr className=" border-black opacity-25" />
      <br />
      <p>
        Each fall, our church celebrates the giving of Bibles in our worship by giving a Bible story
        book to our kindergartners, an age-appropriate Bible to our third graders, and (during
        confirmation years) a study Bible to our confirmands.
      </p>
      <p>

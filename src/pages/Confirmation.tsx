...
export default function Confirmation() {
  ...
  return (
    <div className="mx-5 my-10 space-y-4">
      <h1 className="text-4xl font-medium text-center">Confirmation</h1>
      <br />
      <hr className=" border-black opacity-25" />
      <br />
      <p>
        Every other year, we hold confirmation classes for youth in grades 7 and 8. Each youth
        receives his or her own special study Bible during Bible week in September. Classes are held
        twice a month for the next half year thereafter. Confirmands regularly serve as worship
        helpers and participate in special services such as Good Friday and Ash Wednesday. Together
        they visit other faith communities and take part in mission service projects. The

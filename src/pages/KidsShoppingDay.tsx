    ...
    <>
      ...
      <div className="mx-5 my-10 space-y-4">
        ...
        <p>
          ...
          can shop for Christmas presents for their family members at garage sale prices. Parents
          stay hidden so they don't ruin the surprise, and there are helpers to help the kids shop
          and wrap presents. It is a lot of fun for everyone, and the proceeds go towards providing
          food support for local families in need.
        </p>

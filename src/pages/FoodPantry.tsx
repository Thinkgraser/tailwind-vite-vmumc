...
export default function FoodPantry() {
  ...
  return (
    <div className="mx-5 my-10 space-y-6">
      ...
      <p>
        Cash donations are wonderful because the money can be used for purchases at the Food Bank of
        Iowa at 17¢ a pound. Donations of goods are, of course, also welcome.
      </p>

      ...
      <HomeSection
        text={
          <div className="space-y-4">
            <div>
              <strong>
                Trunk or Treat is held near the end of October in the Van Meter UMC Parking Lot from
                6-8 PM.
              </strong>
            </div>
            <div>
        ...
        imageWidth="11/12"
      />
      <h5 className="text-center text-xl font-medium">Here are some scenes from Trunk or Treat</h5>
